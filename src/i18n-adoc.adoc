...
* Simple text markups are not so simple. To take full advantage of it, one needs a certain level of skills. Try to give a translator the `.po` files. Will they be ready to make a translation? Or they'll ask you for text in a more traditional format like Microsoft Word.
